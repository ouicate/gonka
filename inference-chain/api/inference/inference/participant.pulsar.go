...
var (
	...
	fd_CurrentEpochStats_first_missed_block     protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_CurrentEpochStats_first_missed_block = md_CurrentEpochStats.Fields().ByName("first_missed_block")
}
...
func (x *fastReflection_CurrentEpochStats) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.FirstMissedBlock != uint64(0) {
		value := protoreflect.ValueOfUint64(x.FirstMissedBlock)
		if !f(fd_CurrentEpochStats_first_missed_block, value) {
			return
		}
	}
}
...
func (x *fastReflection_CurrentEpochStats) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.CurrentEpochStats.first_missed_block":
		return x.FirstMissedBlock != uint64(0)
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_CurrentEpochStats) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.CurrentEpochStats.first_missed_block":
		panic(fmt.Errorf("field first_missed_block of message inference.inference.CurrentEpochStats is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.CurrentEpochStats"))
		}
...
func (x *fastReflection_CurrentEpochStats) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.FirstMissedBlock != 0 {
			n += 1 + runtime.Sov(uint64(x.FirstMissedBlock))
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.FirstMissedBlock != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.FirstMissedBlock))
			i--
			dAtA[i] = 0x40
		}
		if x.InvalidatedInferences != 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 8:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field FirstMissedBlock", wireType)
				}
				x.FirstMissedBlock = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, runtime.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.FirstMissedBlock |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
func (x *CurrentEpochStats) GetFirstMissedBlock() uint64 {
	if x != nil {
		return x.FirstMissedBlock
	}
	return 0
}
...
var file_inference_inference_participant_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x74, 0x73, 0x22, 0xea, 0x02, 0x0a, 0x11, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74,
	...
	0x63, 0x65, 0x73, 0x12, 0x2c, 0x0a, 0x12, 0x66, 0x69, 0x72, 0x73, 0x74, 0x5f, 0x6d, 0x69, 0x73,
	0x73, 0x65, 0x64, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x18, 0x08, 0x20, 0x01, 0x28, 0x04, 0x52,
	0x10, 0x66, 0x69, 0x72, 0x73, 0x74, 0x4d, 0x69, 0x73, 0x73, 0x65, 0x64, 0x42, 0x6c, 0x6f, 0x63,
	0x6b, 0x2a, 0x58, 0x0a, 0x11, 0x50, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74,
	...
	0x02, 0x12, 0x0b, 0x0a, 0x07, 0x49, 0x4e, 0x56, 0x41, 0x4c, 0x49, 0x44, 0x10, 0x03, 0x12, 0x0b,
	0x0a, 0x07, 0x52, 0x41, 0x4d, 0x50, 0x49, 0x4e, 0x47, 0x10, 0x04, 0x42, 0xbe, 0x01, 0x0a, 0x17,
	0x63, 0x6f, 0x6d, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x2e, 0x69, 0x6e,
	0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x42, 0x10, 0x50, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69,
	0x70, 0x61, 0x6e, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x24, 0x63, 0x6f, 0x73,
