...
type PocParams struct {
	...
	WeightScaleFactor            *Decimal `protobuf:"bytes,4,opt,name=weight_scale_factor,json=weightScaleFactor,proto3" json:"weight_scale_factor,omitempty"` // Scale factor for PoC weights (default: 1.0 if not set)
}
...
var file_inference_inference_params_proto_rawDesc = []byte{
	...
	0x6f, 0x6c, 0x64, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0x8c, 0x02, 0x0a, 0x09, 0x50, 0x6f,
	...
	0x6f, 0x72, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0x41, 0x0a, 0x07, 0x44, 0x65, 0x63, 0x69,
...
var file_inference_inference_params_proto_depIdxs = []int32{
	...
	6,  // 31: inference.inference.PocParams.weight_scale_factor:type_name -> inference.inference.Decimal
	6,  // 32: inference.inference.CollateralParams.slash_fraction_invalid:type_name -> inference.inference.Decimal
	6,  // 33: inference.inference.CollateralParams.slash_fraction_downtime:type_name -> inference.inference.Decimal
	6,  // 34: inference.inference.CollateralParams.downtime_missed_percentage_threshold:type_name -> inference.inference.Decimal
	6,  // 35: inference.inference.CollateralParams.base_weight_ratio:type_name -> inference.inference.Decimal
	6,  // 36: inference.inference.CollateralParams.collateral_per_weight_unit:type_name -> inference.inference.Decimal
	6,  // 37: inference.inference.BitcoinRewardParams.decay_rate:type_name -> inference.inference.Decimal
	6,  // 38: inference.inference.BitcoinRewardParams.utilization_bonus_factor:type_name -> inference.inference.Decimal
	6,  // 39: inference.inference.BitcoinRewardParams.full_coverage_bonus_factor:type_name -> inference.inference.Decimal
	6,  // 40: inference.inference.BitcoinRewardParams.partial_coverage_bonus_factor:type_name -> inference.inference.Decimal
	6,  // 41: inference.inference.DynamicPricingParams.stability_zone_lower_bound:type_name -> inference.inference.Decimal
	6,  // 42: inference.inference.DynamicPricingParams.stability_zone_upper_bound:type_name -> inference.inference.Decimal
	6,  // 43: inference.inference.DynamicPricingParams.price_elasticity:type_name -> inference.inference.Decimal
	6,  // 44: inference.inference.BandwidthLimitsParams.kb_per_input_token:type_name -> inference.inference.Decimal
	6,  // 45: inference.inference.BandwidthLimitsParams.kb_per_output_token:type_name -> inference.inference.Decimal
	6,  // 46: inference.inference.ConfirmationPoCParams.alpha_threshold:type_name -> inference.inference.Decimal
	6,  // 47: inference.inference.ConfirmationPoCParams.slash_fraction:type_name -> inference.inference.Decimal
