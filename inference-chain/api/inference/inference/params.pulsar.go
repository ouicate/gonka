...
var file_inference_inference_params_proto_rawDesc = []byte{
	...
	0x61, 0x78, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0xf6, 0x0c, 0x0a, 0x10, 0x56, 0x61, 0x6c,
	...
	0x69, 0x6f, 0x6e, 0x50, 0x72, 0x65, 0x73, 0x65, 0x72, 0x76, 0x65, 0x3a, 0x04, 0xe8, 0xa0, 0x1f,
	...
	0x6e, 0x50, 0x72, 0x69, 0x63, 0x65, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0xee, 0x03, 0x0a,
	...
	0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x42, 0xb9, 0x01,
...
var file_inference_inference_params_proto_depIdxs = []int32{
	...
	6,  // 28: inference.inference.CollateralParams.slash_fraction_invalid:type_name -> inference.inference.Decimal
	6,  // 29: inference.inference.CollateralParams.slash_fraction_downtime:type_name -> inference.inference.Decimal
	6,  // 30: inference.inference.CollateralParams.downtime_missed_percentage_threshold:type_name -> inference.inference.Decimal
	6,  // 31: inference.inference.CollateralParams.base_weight_ratio:type_name -> inference.inference.Decimal
	6,  // 32: inference.inference.CollateralParams.collateral_per_weight_unit:type_name -> inference.inference.Decimal
	6,  // 33: inference.inference.BitcoinRewardParams.decay_rate:type_name -> inference.inference.Decimal
	6,  // 34: inference.inference.BitcoinRewardParams.utilization_bonus_factor:type_name -> inference.inference.Decimal
	6,  // 35: inference.inference.BitcoinRewardParams.full_coverage_bonus_factor:type_name -> inference.inference.Decimal
	6,  // 36: inference.inference.BitcoinRewardParams.partial_coverage_bonus_factor:type_name -> inference.inference.Decimal
	6,  // 37: inference.inference.DynamicPricingParams.stability_zone_lower_bound:type_name -> inference.inference.Decimal
	6,  // 38: inference.inference.DynamicPricingParams.stability_zone_upper_bound:type_name -> inference.inference.Decimal
	6,  // 39: inference.inference.DynamicPricingParams.price_elasticity:type_name -> inference.inference.Decimal
	6,  // 40: inference.inference.BandwidthLimitsParams.kb_per_input_token:type_name -> inference.inference.Decimal
	6,  // 41: inference.inference.BandwidthLimitsParams.kb_per_output_token:type_name -> inference.inference.Decimal
