...
var file_inference_inference_params_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x67, 0x4d, 0x61, 0x78, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0xcc, 0x0d, 0x0a,
	...
	0x73, 0x68, 0x6f, 0x6c, 0x64, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0xbe, 0x01, 0x0a, 0x09,
	...
	0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0xee, 0x03, 0x0a, 0x15, 0x42, 0x61, 0x6e, 0x64, 0x77,
	...
	0x73, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0xae, 0x02, 0x0a, 0x15, 0x43, 0x6f, 0x6e, 0x66,
	...
	0x6f, 0x77, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x42, 0xb9, 0x01, 0x0a, 0x17, 0x63, 0x6f, 0x6d,
	0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72,
...
var file_inference_inference_params_proto_depIdxs = []int32{
	...
	6,  // 29: inference.inference.ValidationParams.quick_failure_threshold:type_name -> inference.inference.Decimal
	6,  // 30: inference.inference.CollateralParams.slash_fraction_invalid:type_name -> inference.inference.Decimal
	6,  // 31: inference.inference.CollateralParams.slash_fraction_downtime:type_name -> inference.inference.Decimal
	6,  // 32: inference.inference.CollateralParams.downtime_missed_percentage_threshold:type_name -> inference.inference.Decimal
	6,  // 33: inference.inference.CollateralParams.base_weight_ratio:type_name -> inference.inference.Decimal
	6,  // 34: inference.inference.CollateralParams.collateral_per_weight_unit:type_name -> inference.inference.Decimal
	6,  // 35: inference.inference.BitcoinRewardParams.decay_rate:type_name -> inference.inference.Decimal
	6,  // 36: inference.inference.BitcoinRewardParams.utilization_bonus_factor:type_name -> inference.inference.Decimal
	6,  // 37: inference.inference.BitcoinRewardParams.full_coverage_bonus_factor:type_name -> inference.inference.Decimal
	6,  // 38: inference.inference.BitcoinRewardParams.partial_coverage_bonus_factor:type_name -> inference.inference.Decimal
	6,  // 39: inference.inference.DynamicPricingParams.stability_zone_lower_bound:type_name -> inference.inference.Decimal
	6,  // 40: inference.inference.DynamicPricingParams.stability_zone_upper_bound:type_name -> inference.inference.Decimal
	6,  // 41: inference.inference.DynamicPricingParams.price_elasticity:type_name -> inference.inference.Decimal
	6,  // 42: inference.inference.BandwidthLimitsParams.kb_per_input_token:type_name -> inference.inference.Decimal
	6,  // 43: inference.inference.BandwidthLimitsParams.kb_per_output_token:type_name -> inference.inference.Decimal
	6,  // 44: inference.inference.ConfirmationPoCParams.alpha_threshold:type_name -> inference.inference.Decimal
	6,  // 45: inference.inference.ConfirmationPoCParams.slash_fraction:type_name -> inference.inference.Decimal
