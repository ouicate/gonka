...
var (
	...
	fd_CollateralParams_downtime_grace_blocks                protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_CollateralParams_downtime_grace_blocks = md_CollateralParams.Fields().ByName("downtime_grace_blocks")
}
...
func (x *fastReflection_CollateralParams) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.DowntimeGraceBlocks != uint64(0) {
		value := protoreflect.ValueOfUint64(x.DowntimeGraceBlocks)
		if !f(fd_CollateralParams_downtime_grace_blocks, value) {
			return
		}
	}
}
...
func (x *fastReflection_CollateralParams) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.CollateralParams.downtime_grace_blocks":
		return x.DowntimeGraceBlocks != uint64(0)
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_CollateralParams) Clear(fd protoreflect.FieldDescriptor) {
	...
	case "inference.inference.CollateralParams.downtime_grace_blocks":
		x.DowntimeGraceBlocks = uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.CollateralParams"))
		}
...
func (x *fastReflection_CollateralParams) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "inference.inference.CollateralParams.downtime_grace_blocks":
		x.DowntimeGraceBlocks = value.Uint()
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.CollateralParams"))
		}
...
func (x *fastReflection_CollateralParams) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.CollateralParams.downtime_grace_blocks":
		panic(fmt.Errorf("field downtime_grace_blocks of message inference.inference.CollateralParams is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.CollateralParams"))
		}
...
func (x *fastReflection_CollateralParams) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.DowntimeGraceBlocks != 0 {
			n += 1 + runtime.Sov(uint64(x.DowntimeGraceBlocks))
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.DowntimeGraceBlocks != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.DowntimeGraceBlocks))
			i--
			dAtA[i] = 0x38
		}
		if x.CollateralPerWeightUnit != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 7:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field DowntimeGraceBlocks", wireType)
				}
				x.DowntimeGraceBlocks = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, runtime.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.DowntimeGraceBlocks |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
func (x *CollateralParams) GetDowntimeGraceBlocks() uint64 {
	if x != nil {
		return x.DowntimeGraceBlocks
	}
	return 0
}
...
var file_inference_inference_params_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0xbf, 0x04, 0x0a, 0x10, 0x43, 0x6f, 0x6c,
	...
	0x12, 0x32, 0x0a, 0x15, 0x64, 0x6f, 0x77, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x67, 0x72, 0x61,
	0x63, 0x65, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x04, 0x52,
	0x13, 0x64, 0x6f, 0x77, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x47, 0x72, 0x61, 0x63, 0x65, 0x42, 0x6c,
	0x6f, 0x63, 0x6b, 0x73, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0xf3, 0x03, 0x0a, 0x13, 0x42,
	...
	0xa0, 0x1f, 0x01, 0x22, 0xa4, 0x03, 0x0a, 0x15, 0x42, 0x61, 0x6e, 0x64, 0x77, 0x69, 0x64, 0x74,
	...
	0x75, 0x72, 0x76, 0x65, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x42, 0xb9, 0x01, 0x0a, 0x17, 0x63,
