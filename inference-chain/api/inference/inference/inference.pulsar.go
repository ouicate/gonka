...
var (
	...
	fd_Inference_seed                         protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Inference_seed = md_Inference.Fields().ByName("seed")
}
...
func (x *fastReflection_Inference) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.Inference.seed":
...
func (x *fastReflection_Inference) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.Inference.seed":
		panic(fmt.Errorf("field seed of message inference.inference.Inference is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.Inference"))
		}
...
func (x *Inference) GetSeed() int32 {
	if x != nil {
		return x.Seed
	}
	return 0
...
var file_inference_inference_inference_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x79, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x89, 0x0b, 0x0a, 0x09, 0x49,
	...
	,
