...
var (
	...
	ActiveParticipantsMerkleProofPrefix = collections.NewPrefix(24)
	BlockProofPrefix                    = collections.NewPrefix(25)
	PendingProofPrefix                  = collections.NewPrefix(26)
	ValidatorsProofPrefix               = collections.NewPrefix(27)
