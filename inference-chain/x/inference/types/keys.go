...
var (
	...
	BridgeContractAddressesPrefix     = collections.NewPrefix(24)
	BridgeTransactionsPrefix          = collections.NewPrefix(25)
	WrappedTokenCodeIDPrefix          = collections.NewPrefix(26)
	WrappedTokenMetadataPrefix        = collections.NewPrefix(27)
	WrappedTokenContractsPrefix       = collections.NewPrefix(28)
	WrappedContractReverseIndexPrefix = collections.NewPrefix(29)
	LiquidityPoolPrefix               = collections.NewPrefix(30)
	LiquidityPoolApprovedTokensPrefix = collections.NewPrefix(31)
