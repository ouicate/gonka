...
type CollateralParams struct {
	...
	// downtime_grace_blocks is the minimum number of blocks to wait after the
	// first missed inference before applying a downtime slash. This gates
	// immediate slashing to avoid punishing transient outages.
	DowntimeGraceBlocks uint64 `protobuf:"varint,7,opt,name=downtime_grace_blocks,json=downtimeGraceBlocks,proto3" json:"downtime_grace_blocks,omitempty"`
}
...
func (m *CollateralParams) GetDowntimeGraceBlocks() uint64 {
	if m != nil {
		return m.DowntimeGraceBlocks
	}
	return 0
}
...
var fileDescriptor_3cf34332021bbe94 = []byte{
	...
	0xb1, 0x24, 0x3e, 0x42, 0x4e, 0xf9, 0x08, 0x39, 0xe4, 0x03, 0xf0, 0x09, 0x92, 0x6b, 0x8e, 0x5b,
	...
	0xe2, 0xfb, 0x1f, 0xfd, 0xfb, 0x8f, 0x37, 0xa6, 0x7e, 0xff, 0xaf, 0xd7, 0x77, 0x36, 0x8a, 0x3c,
	...
	0xd7, 0x6d, 0x97, 0xfb, 0x7f, 0x9e, 0x42, 0xf3, 0xf9, 0x73, 0x16, 0x7f, 0x82, 0x70, 0xd6, 0x3d,
	...
	0xd3, 0x41, 0x22, 0x38, 0x75, 0x13, 0xd7, 0xac, 0x97, 0xff, 0xed, 0x28, 0xfe, 0x32, 0x83, 0x6a,
	...
	,
}
...
func (this *CollateralParams) Equal(that interface{}) bool {
	...
	if this.DowntimeGraceBlocks != that1.DowntimeGraceBlocks {
		return false
	}
	return true
}
...
func (m *CollateralParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.DowntimeGraceBlocks != 0 {
		i = encodeVarintParams(dAtA, i, uint64(m.DowntimeGraceBlocks))
		i--
		dAtA[i] = 0x38
	}
...
func (m *CollateralParams) Size() (n int) {
	...
	if m.DowntimeGraceBlocks != 0 {
		n += 1 + sovParams(uint64(m.DowntimeGraceBlocks))
	}
	return n
}
...
func (m *CollateralParams) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DowntimeGraceBlocks", wireType)
			}
			m.DowntimeGraceBlocks = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowParams
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DowntimeGraceBlocks |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
