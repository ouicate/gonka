...
type QueryGetRandomExecutorRequest struct {
	...
	// Deterministic seed for selection (e.g., inference id)
...
func (m *QueryGetRandomExecutorRequest) GetInferenceId() string {
	if m != nil {
...
type QueryGetRandomExecutorResponse struct {
	...
	// Addresses considered but skipped during deterministic selection
	SkippedExecutors []string `protobuf:"bytes,2,rep,name=skipped_executors,json=skippedExecutors,proto3" json:"skipped_executors,omitempty"`
}
...
func (m *QueryGetRandomExecutorResponse) GetSkippedExecutors() []string {
	if m != nil {
		return m.SkippedExecutors
	}
	return nil
}
...
var fileDescriptor_cf0cfe3b0e1cc5bd = []byte{
	...
	,
}
...
func (m *QueryGetRandomExecutorResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.SkippedExecutors) > 0 {
		for iNdEx := len(m.SkippedExecutors) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.SkippedExecutors[iNdEx])
			copy(dAtA[i:], m.SkippedExecutors[iNdEx])
			i = encodeVarintQuery(dAtA, i, uint64(len(m.SkippedExecutors[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *QueryGetRandomExecutorResponse) Size() (n int) {
	...
	n += 1 + l + sovQuery(uint64(l))
	if len(m.SkippedExecutors) > 0 {
		for _, s := range m.SkippedExecutors {
			l = len(s)
			n += 1 + l + sovQuery(uint64(l))
		}
	}
...
func (m *QueryGetRandomExecutorResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SkippedExecutors", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SkippedExecutors = append(m.SkippedExecutors, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQuery(dAtA[iNdEx:])
