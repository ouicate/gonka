...
class ParticipantPowerTests : TestermintTest() {
    ...
    fun `power to zero removes participant from validators`() {
        ...
        assertThat(zeroValidator.getStatusAsInt()).isEqualTo(StakeValidatorStatus.UNBONDING.value)
    ...
    fun `power to zero and back again restores validator`() {
        ...
        assertThat(rejoinedValidator.getStatusAsInt()).isEqualTo(StakeValidatorStatus.BONDED.value)
