...
class NodeAdminStateTests : TestermintTest() {
    ...
    fun `test node disable during inference phase`() {
        ...
        assertThat(genesisValidatorBeforeDisabled.getStatusAsInt()).isEqualTo(StakeValidatorStatus.BONDED.value)
        ...
        assertThat(genesisValidatorAfterNodeIsDisabled.getStatusAsInt()).isEqualTo(StakeValidatorStatus.UNBONDING.value)
    }
    ...
    fun `test node disable during PoC phase`() {
        ...
        assertThat(genesisStakeValidatorWhenDisabledAtPoc.getStatusAsInt()).isEqualTo(StakeValidatorStatus.BONDED.value)
        ...
        assertThat(genesisValidatorAfterOneMoreEpoch.getStatusAsInt()).isEqualTo(StakeValidatorStatus.UNBONDING.value)
