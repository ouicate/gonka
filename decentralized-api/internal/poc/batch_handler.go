...
func NewBatchHandler(nodeID string, recorder cosmosclient.CosmosMessageClient) *BatchHandler {
	return &BatchHandler{
		nodeID:   nodeID,
		recorder: recorder,
	}
...
func (h *BatchHandler) HandleGeneratedBatch(batch mlnodeclient.ProofBatch) error {
